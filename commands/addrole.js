      ...
      const row = new MessageActionRow().addComponents(
        new MessageSelectMenu()
          ...
          .addOptions([
            ...
            {
              emoji: "<:GFL:955855289645670430>",
              label: "Girls' Frontline",
              description: "for Girls' Frontline players",
              value: "chk_gfl",
            },
          ])
      );

      const row2 = new MessageActionRow().addComponents(new MessageButton().setCustomId("btn_reset").setLabel("RESET").setStyle("DANGER"));

      const embed = new MessageEmbed()
        .setColor("1155FF")
        .setTitle("Please pick your game role below")
        .setDescription("Silakan ambil game role yang ada di bawah ini\n\nNote: Reset button only reset game roles, dropdown menu not included\nCatatan: Tombol reset hanya mereset semua game roles, menu dropdown tidak termasuk")
